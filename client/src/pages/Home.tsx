    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-20">
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-slate-500 mb-4">
              此 ID
              用于关联你所有的会话记录，存储在浏览器本地。换浏览器或清除数据后会重新生成
              —— 可以「导入」之前的 ID 来恢复历史。
            </p>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-xl bg-indigo-500 hover:bg-indigo-400 disabled:bg-slate-300 text-white text-sm font-medium transition-all"
                  >
                    导入
                  </button>
                </div>
            ...
            {confirmRegen && (
              <div className="bg-red-50 border border-red-100 rounded-xl p-4">
                <p className="text-sm text-red-600 mb-3">
                  ⚠️ 换 ID 后将无法访问当前 ID 下的会话记录（除非保存原 ID
                  以便日后导入）。
                </p>
                <div className="flex gap-2">
                  <button
                  ...
                  <button
                    ...
                    className="flex-1 py-2 rounded-lg bg-red-500 hover:bg-red-400 text-white text-sm font-medium transition-all"
                  >
                    确认更换
                  </button>
                </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
        {tools.map((tool) => (
          ...
          >
            <div
              className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br ${tool.gradient} text-white mb-5 shadow-lg`}
            >
              {tool.icon}
            </div>
